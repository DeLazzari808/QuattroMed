  ...
  return (
    <section id="como-funciona" className="py-20 lg:py-28 relative overflow-hidden bg-white">
      <Container className="relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center max-w-5xl mx-auto relative gap-6 lg:gap-0">
          {/* Left: Steps Card */}
          <motion.div
          ...
          >
            <div className="relative w-[220px] sm:w-[280px] lg:w-[340px]">
              ...
              <div className="relative bg-neutral-900 rounded-[2.5rem] sm:rounded-[3rem] p-1.5 sm:p-2 shadow-2xl">
                ...
                >
                  {/* Status Bar */}
                  <div className="flex justify-between items-center px-6 sm:px-8 pt-3 sm:pt-4 text-white/60 text-[10px] sm:text-xs font-modelica">
                    <span className="font-medium">9:41</span>
                    <div className="flex items-center gap-1">
                      <div className="w-3 sm:w-4 h-1.5 sm:h-2 border border-white/60 rounded-sm">
