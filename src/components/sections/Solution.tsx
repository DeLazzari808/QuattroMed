  ...
  return (
    ...
    >
      ...
      <Container className="relative z-10">
        ...
        {/* Doctor Cards */}
        <div className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-4 pb-4 -mx-4 px-4 sm:grid sm:grid-cols-3 sm:overflow-visible sm:pb-0 sm:mx-auto sm:px-0 sm:gap-6 lg:gap-8 mb-10 lg:mb-16 max-w-5xl">
          {doctors.map((doc, idx) => (
            <AnimatedSection key={idx} delay={idx * 0.1} className="min-w-[85vw] sm:min-w-0 snap-center">
              <div
