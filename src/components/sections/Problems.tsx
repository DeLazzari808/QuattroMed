      ...
      <Container className="relative z-10">
        ...
        <div className="max-w-3xl mb-8 lg:mb-12">
          <AnimatedSection>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-5xl font-bold leading-[1.15] mb-4 sm:mb-6 font-modelica" style={{ color: '#004AAD' }}>
            ...
            <p className="text-sm sm:text-base lg:text-lg text-neutral-600 max-w-2xl leading-relaxed font-modelica">
              ...
              <span className="font-bold" style={{ color: '#004AAD' }}>QuatroMed</span>{' '}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 lg:gap-5">
          ...
          >
            ...
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-2 sm:mb-3 font-modelica" style={{ color: '#004AAD' }}>
              Custos Elevados
            </h3>
